...
function UpdateModulesList($rootLocation, $packages,$path) {
    $moduleList = "|PackageName|[![Custom badge](https://img.shields.io/endpoint.svg?label=Downloads&url=https%3A%2F%2Fxpandnugetstats.azurewebsites.net%2Fapi%2Ftotals%2FXAF)](https://www.nuget.org/packages?q=Xpand.XAF)<br>Platform/Target|About`r`n|---|---|---|`r`n"
    ...
    $packages | ForEach-Object {
        ...
        $moduleList += "$packageUri|![](https://img.shields.io/badge/$platform-$targetFramework-yellowgreen)<br>$version$downloads|$about`r`n"
    }
...
[![GitHub issues](https://img.shields.io/github/issues/eXpandFramework/expand/$package.svg)](https://github.com/eXpandFramework/eXpand/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aopen+sort%3Aupdated-desc+label%3AReactive.XAF+label%3A$package) [![GitHub close issues](https://img.shields.io/github/issues-closed/eXpandFramework/eXpand/$package.svg)](https://github.com/eXpandFramework/eXpand/issues?utf8=%E2%9C%93&q=is%3Aissue+is%3Aclosed+sort%3Aupdated-desc+label%3AReactive.XAF+label%3A$package)
"@
