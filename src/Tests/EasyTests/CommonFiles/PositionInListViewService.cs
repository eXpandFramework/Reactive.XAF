...
namespace Win.Tests {
    public static class PositionInListViewService {
        ...
        private static void CheckMoveDown(this ICommandAdapter adapter) {
            adapter.Execute(new ActionAvailableCommand(GetActionName(nameof(SwapPositionInListViewService.MoveObjectUp))) {ExpectException = true});
            ...
            adapter.Execute(new ActionAvailableCommand(GetActionName(nameof(SwapPositionInListViewService.MoveObjectDown))) {ExpectException = true});
