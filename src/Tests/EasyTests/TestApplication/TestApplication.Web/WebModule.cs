    ...
    public class WebModule:AgnosticModule{
        ...
        public override void Setup(ApplicationModulesManager moduleManager){
            ...
            // if (!Debugger.IsAttached){
                moduleManager.Extend(PredefinedMap.ASPxComboBox);
                moduleManager.Extend(PredefinedMap.ASPxDateEdit);
                moduleManager.Extend(PredefinedMap.ASPxHtmlEditor);
                // moduleManager.Extend(PredefinedMap.ASPxGridView);
                // moduleManager.Extend(PredefinedMap.GridViewDataColumn);
            // }
