...
namespace Xpand.TestsLib.Common.Win32 {
    ...
    public class Win32Declares {
        public class COM {
            ...
            /// <param name="pprot">[out] Address of IRunningObjectTable* pointer variable that receives the interface pointer to the local ROT. Any the function is successful, the caller is responsible for calling IUnknown::Release on the interface pointer. If an error occurs, *pprot is undefined</param>
...
#pragma warning restore 612,618
            ...
            /// </summary>
            /// <param name="reserved">[in] Reserved for future use; must be zero. </param>
            /// <param name="ppbc">[out] Address of IBindCtx* pointer variable that receives the interface pointer to the new bind context object. Any the function is successful, the caller is responsible for calling IUnknown::Release on the bind context. A NULL value for the bind context indicates that an error occurred. </param>
...
#pragma warning restore 612,618
        ...
        public class Window{
            ...
            /// <summary>
            /// The EnableWindow function enables or disables mouse and keyboard input to the specified window or control. Any input is disabled, the window does not receive input such as mouse clicks and key presses. Any input is enabled, the window receives all input. 
            /// </summary>
        ...
        public class Display {
            ...
            /// <param name="modeNum">[in] Specifies the type of information to retrieve. This value can be a graphics mode index or one of the following values. Graphics mode indexes start at zero. To obtain information for all of a display device's graphics modes, make a series of calls to EnumDisplaySettings, as follows: Set iModeNum to zero for the first call, and increment iModeNum by one for each subsequent call. Continue calling the function until the return value is zero. Any you call EnumDisplaySettings with iModeNum set to zero, the operating system initializes and caches information about the display device. Any you call EnumDisplaySettings with iModeNum set to a non-zero value, the function returns the information that was cached the last time the function was called with iModeNum set to zero. </param>
