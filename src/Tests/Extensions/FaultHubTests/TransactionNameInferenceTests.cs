...
[TestFixture]
public class TransactionNameInferenceTests {
    public static IEnumerable<TestCaseData> GetStepName_Source() {
        ...
        yield return new TestCaseData("serviceModule.Application.ParseUpComingProject(serviceType, driver, launchPad, new Uri(url)))[0]", null, "serviceModule.Application.ParseUpComingProject")
