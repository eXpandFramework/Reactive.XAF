namespace TestApplication.Win {
	partial class TestApplicationWindowsFormsApplication {
		/// <summary> 
		...
		private void InitializeComponent() {
			...
			// sqlConnection1
			// 
			this.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=TestApplication;Integrated Security=SSPI;Pooling=false";
			this.sqlConnection1.FireInfoMessageEventOnUserErrors = false;
			// 
			// TestApplicationWindowsFormsApplication
			// 
			this.ApplicationName = "TestApplication";
