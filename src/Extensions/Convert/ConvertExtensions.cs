...
namespace DevExpress.XAF.Extensions.Convert{
    public static class ConvertExtensions {
        ...
        public static bool CanChange<T>(this object value) {
            return TryToChange(value, out T _);
        }

        public static bool CanChange<T>(this string value, CultureInfo culture) {
        ...
        public static bool CanChange<T>(this object value, CultureInfo culture, Conversion options) {
            return TryToChange(value, out T _, culture, options);
        }

        public static bool TryToChange<T>(this object value, out T result) {
            return TryToChange(value, out result, DefaultCultureInfo);
        }

        public static bool TryToChange<T>(this object value, out T result, CultureInfo culture) {
            return TryToChange(value, out result, culture, DefaultConversion);
        }

        public static bool TryToChange<T>(this object value, out T result, Conversion options) {
            return TryToChange(value, out result, DefaultCultureInfo, options);
        }

        public static bool TryToChange<T>(this object value, out T result, CultureInfo culture, Conversion options) {
        ...
        static bool IsNullString(string asString) {
            return asString != "" && string.CompareOrdinal("(NULL)", asString) == 0;
        }
        ...
        private static bool TryChangeToEnum(object value, Type destinationType, ref object result) {
            var enumTryParse = destinationType.EnumTryParse(value.ToString(), out object o);
            if (enumTryParse)
                result = o;
            return enumTryParse;
        }
        ...
        public static object Change(this object value, Type destinationType, CultureInfo culture, Conversion options) {
            ...
            throw new TypeCannotChangedException(value, destinationType);
        }
    }
    /// <summary>
    /// The exception that is thrown when a conversion is invalid.
    /// </summary>
    public class TypeCannotChangedException : InvalidOperationException {

        /// <summary>
        /// Initializes a new instance of the <see cref="TypeCannotChangedException">TypeCannotChanged</see> class.
        /// </summary>
        /// <param name="valueToConvert"></param>
        /// <param name="destinationType"></param>
        public TypeCannotChangedException(object valueToConvert, Type destinationType)
            : base(
