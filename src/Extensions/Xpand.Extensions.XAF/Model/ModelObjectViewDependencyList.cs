...
namespace Xpand.Extensions.XAF.Model{
    ...
    public static class ModelObjectViewDependencyLogic {
        public static Dictionary<System.Type,System.Type> ObjectViewsMap=new Dictionary<System.Type, System.Type>();
        ...
        public static IModelObjectView Get_ObjectView(IModelObjectViewDependency todoObjectView){
            return !string.IsNullOrEmpty(todoObjectView.ObjectViewId) ? todoObjectView.Application.Views[todoObjectView.ObjectViewId].AsObjectView : null;
        }
        [UsedImplicitly]
