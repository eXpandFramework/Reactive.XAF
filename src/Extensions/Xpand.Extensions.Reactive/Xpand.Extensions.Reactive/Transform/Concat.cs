...
namespace Xpand.Extensions.Reactive.Transform {
    public static partial class Transform {
        ...
        public static ResilientObservable<object> ConcatToObject<T, T1>(this ResilientObservable<T> source, ResilientObservable<T1> target)
        ...
        public static ResilientObservable<T> ConcatIgnored<T, T2>(this ResilientObservable<T> source, Func<T, IObservable<T2>> secondSelector, Func<T, bool> merge = null)
            => source.ConcatIgnored((arg1, _) => secondSelector(arg1), merge);
        ...
        public static ResilientObservable<T> ConcatIgnored<T>(this ResilientObservable<T> source, Action<T> action, Func<T, bool> merge = null)
            => source.SelectMany(arg => {
                merge ??= _ => true;
                if (merge(arg)) {
                    action(arg);
