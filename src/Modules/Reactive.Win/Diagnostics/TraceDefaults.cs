...
namespace Xpand.XAF.Modules.Reactive.Diagnostics{
    /// <summary>
    ...
    public static class TraceDefaults{
        [SuppressMessage("Microsoft.StyleCop.CSharp.MaintainabilityRules", "SA1401:FieldsMustBePrivate",
            Justification =
                "It's used in a thread-safe manner by only a single consumer, and also it must be exposed for unit testing.")]
        ...
        public static string DefaultOnCompleted(){
            ...
            return Text.DefaultOnCompletedMessage;
        }

        /// <summary>
        ///     Returns a textual representation of the specified <paramref name="value" /> for the specified
        ///     <paramref name="observerId" />.
        /// </summary>
        /// <typeparam name="T">Type of <paramref name="value" />.</typeparam>
        /// <param name="observerId">The identity of the observer that received this notification.</param>
        /// <param name="value">The object for which a string representation is returned.</param>
        /// <returns>
        ///     String that represents the specified <paramref name="value" /> for the specified
        ///     <paramref name="observerId" />.
        /// </returns>
        ...
        /// <summary>
        ///     Returns a textual representation of the specified <paramref name="exception" /> for the specified
        ///     <paramref name="observerId" />.
        /// </summary>
        /// <param name="observerId">The identity of the observer that received this notification.</param>
        /// <param name="exception">The object for which a string representation is returned.</param>
        /// <returns>
        ///     String that represents the specified <paramref name="exception" /> for the specified
        ///     <paramref name="observerId" />.
        /// </returns>
