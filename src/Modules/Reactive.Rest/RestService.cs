...
namespace Xpand.XAF.Modules.Reactive.Rest {
    ...
    public static class RestService {
        ...
        internal static IObservable<TSource> TraceRestModule<TSource>(this IObservable<TSource> source, Func<TSource,string> messageFactory=null,string name = null, Action<ITraceEvent> traceAction = null,
            ...
            source.Trace(name, RestModule.TraceSource,messageFactory,errorMessageFactory, traceAction, traceStrategy,allMessageFactory, memberName,sourceFilePath,sourceLineNumber);
    }
