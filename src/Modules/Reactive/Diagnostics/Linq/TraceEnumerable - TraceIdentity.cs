...
using System.Linq;
using Xpand.XAF.Modules.Reactive.Diagnostics.Reactive;

namespace Xpand.XAF.Modules.Reactive.Diagnostics.Linq{
    public static partial class TraceEnumerable{
        ...
        public static IEnumerable<T> TraceIdentityOnNext<T>(this IEnumerable<T> source, string format){
            ...
            var enumerable =
                source.Do(new IdentifiedTraceObserver<T>(TraceDefaults.GetIdentityFormatOnNext<T>(format)));
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:Dispose objects before losing scope",
            Justification = "Internal object that doesn't need disposal.")]
        public static IEnumerable<T> TraceIdentityOnNext<T>(this IEnumerable<T> source,
            Func<string, T, string> messageSelector){
            Contract.Requires(source != null);
        ...
        public static IEnumerable<T> TraceIdentityOnError<T>(this IEnumerable<T> source, string format){
            ...
            var enumerable =
                source.Do(
                    new IdentifiedTraceObserver<T>((a, b) => null, TraceDefaults.GetIdentityFormatOnError(format)));
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:Dispose objects before losing scope",
            Justification = "Internal object that doesn't need disposal.")]
        public static IEnumerable<T> TraceIdentityOnError<T>(this IEnumerable<T> source,
            Func<string, Exception, string> messageSelector){
            Contract.Requires(source != null);
            Contract.Requires(messageSelector != null);
            Contract.Ensures(Contract.Result<IEnumerable<T>>() != null);
        ...
        public static IEnumerable<T> TraceIdentityOnCompleted<T>(this IEnumerable<T> source){
            ...
            var enumerable =
                source.Do(new IdentifiedTraceObserver<T>((a, b) => null, TraceDefaults.DefaultOnCompleted));
        ...
        public static IEnumerable<T> TraceIdentityOnCompleted<T>(this IEnumerable<T> source, string message){
            ...
            var enumerable = source.Do(new IdentifiedTraceObserver<T>((a, b) => null,
                TraceDefaults.GetIdentityMessageOnCompleted(message)));
        ...
        [SuppressMessage("Microsoft.Reliability", "CA2000:Dispose objects before losing scope",
            Justification = "Internal object that doesn't need disposal.")]
        public static IEnumerable<T> TraceIdentityOnCompleted<T>(this IEnumerable<T> source,
            Func<string, string> messageSelector){
            Contract.Requires(source != null);
            Contract.Requires(messageSelector != null);
            Contract.Ensures(Contract.Result<IEnumerable<T>>() != null);
        ...
        public static IEnumerable<T> TraceIdentityOnNext<T>(this IEnumerable<T> source, TraceSource trace,
            ...
            var enumerable =
                source.Do(new IdentifiedTraceObserver<T>(trace, TraceDefaults.GetIdentityFormatOnNext<T>(format)));
        ...
        public static IEnumerable<T> TraceIdentityOnError<T>(this IEnumerable<T> source, TraceSource trace){
            ...
            var enumerable =
                source.Do(new IdentifiedTraceObserver<T>(trace, (a, b) => null, TraceDefaults.DefaultOnError));
        ...
        public static IEnumerable<T> TraceIdentityOnCompleted<T>(this IEnumerable<T> source, TraceSource trace){
            ...
            var enumerable =
                source.Do(new IdentifiedTraceObserver<T>(trace, (a, b) => null, TraceDefaults.DefaultOnCompleted));
