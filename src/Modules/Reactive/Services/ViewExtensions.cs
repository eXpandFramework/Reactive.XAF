...
namespace Xpand.XAF.Modules.Reactive.Services{
    public static class ViewExtensions{
        ...
        public static IObservable<T> WhenSelectionChanged<T>(this T view) where T : View 
            => view.ReturnObservable().SelectionChanged();
        ...
        public static IObservable<T> WhenCurrentObjectChanged<T>(this T controller) where T : View 
            => controller.ReturnObservable().CurrentObjectChanged();
