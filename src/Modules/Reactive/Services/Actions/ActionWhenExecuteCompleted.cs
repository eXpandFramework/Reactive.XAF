...
namespace Xpand.XAF.Modules.Reactive.Services.Actions {
    public static partial class ActionsService {
        ...
        public static IObservable<SingleChoiceActionExecuteEventArgs> WhenExecuteCompleted(
            ...
            => action.ProcessEvent<SingleChoiceActionExecuteEventArgs>(nameof(ActionBase.ExecuteCompleted))
        ...
        public static IObservable<SimpleActionExecuteEventArgs> WhenExecuteCompleted(this SimpleAction action)
            => action.ProcessEvent<SimpleActionExecuteEventArgs>(nameof(ActionBase.ExecuteCompleted))
                .TakeUntilDisposed(action);

        public static IObservable<ParametrizedActionExecuteEventArgs> WhenExecuteCompleted(
            this ParametrizedAction action)
            => action.ProcessEvent<ParametrizedActionExecuteEventArgs>(nameof(ActionBase.ExecuteCompleted))
                .TakeUntilDisposed(action);

        public static IObservable<PopupWindowShowActionExecuteEventArgs> WhenExecuteCompleted(
            this PopupWindowShowAction action)
            => action.ProcessEvent<PopupWindowShowActionExecuteEventArgs>(nameof(ActionBase.ExecuteCompleted))
                .TakeUntilDisposed(action);
