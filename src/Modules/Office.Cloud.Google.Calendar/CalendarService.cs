...
namespace Xpand.XAF.Modules.Office.Cloud.Google.Calendar{
    public static class CalendarService{
        ...
        internal static IObservable<TSource> TraceGoogleCalendarModule<TSource>(this IObservable<TSource> source, Func<TSource,string> messageFactory=null,string name = null, Action<ITraceEvent> traceAction = null,
            ...
            => source.Trace(name, GoogleCalendarModule.TraceSource,messageFactory,errorMessageFactory, traceAction, traceStrategy,allMessageFactory, memberName,sourceFilePath,sourceLineNumber);
